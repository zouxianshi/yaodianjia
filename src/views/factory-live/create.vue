<template>
  <div class="app-cotainer factory-live-create">
    ...
    <el-form ref="rulesForm" :model="liveForm" label-width="100px" :rules="rules" class="demo-ruleForm">
      ...
      <el-form-item label="直播名称：" required>
        <el-input v-model="liveForm.merName" size="mini" style="width:400px" disabled />
      </el-form-item>
      <el-form-item label="直播主题：" prop="name">
        <el-input v-model="liveForm.name" size="mini" style="width:400px" />
      </el-form-item>
      ...
      <el-form-item label="直播简介：" prop="liveIntroduce">
        <el-input
          v-model="liveForm.liveIntroduce"
          type="textarea"
          placeholder="请输入直播简介"
          style="width:400px"
        />
      ...
      <el-form-item label="直播公告：" prop="activityNotice">
        <el-input
          v-model="liveForm.activityNotice"
          type="textarea"
          placeholder="请输入直播简介"
          style="width:400px"
        />
    ...
    <el-form ref="liveForm" :model="liveForm" label-width="100px" class="demo-ruleForm">
      <el-form-item label="参与商品：">
        <el-button type="primary" size="mini" @click="$refs.GoodsComponent.open()">选择商品</el-button>
        <selectedGoods v-show="liveForm.commoditySpecList.length>0" ref="storeGods" @del-item="delSelectGoods" />
      </el-form-item>
      <el-form-item label="直播奖励：">
        成交<el-input-number v-model="liveForm.prizeRule" size="mini" :min="0" :max="99999" :precision="0" :controls="false" />
        奖励<el-input-number v-model="liveForm.prizeAmount" size="mini" :min="0" :max="99999" :precision="0" :controls="false" />
      </el-form-item>
