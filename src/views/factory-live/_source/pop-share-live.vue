  ...
  <el-dialog title="" :visible.sync="dialogVisible" width="800px" :before-close="handleClose" :append-to-body="true">
    <div class="share-live-content">
      <div class="content-left">
        <div v-loading="empCodeLoading" class="pm-qr-code">
      ...
      <div v-loading="loading" class="content-right scrollbar">
        <el-image style="height:200px;width:100%" :src="showImg(baseInfo.coverPicUrl)" />
