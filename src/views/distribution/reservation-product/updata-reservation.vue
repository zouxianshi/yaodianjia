    ...
    <div class="product-info">
      ...
      <el-form ref="form" :rules="rules" :model="form" label-width="100px">
        ...
        <el-form-item label="标签价格：" prop="price">
          <el-input v-model="form.price" onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" maxlength="19" />
        </el-form-item>
        <el-form-item label="库存量：" prop="inventory">
          <el-input v-model="form.inventory" onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" readonly maxlength="11" />
        </el-form-item>
      </el-form>
    </div>
    <div class="product-rules">
      ...
      <el-form :model="form" label-width="100px" class="demo-form-inline">
        <el-form-item label="限购规则：">
          每人&emsp;
          <el-input v-model="form.daysPerMember" onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" maxlength="11" class="inline-input" prop="daysPerMember" />
          &emsp;天内限购&emsp;
          <el-input v-model="form.countPerMember" onkeyup="this.value=this.value.replace(/[^\d.]/g,'');" maxlength="11" class="inline-input" prop="countPerMember" />
          &emsp;个
        </el-form-item>
      </el-form>
    </div>
