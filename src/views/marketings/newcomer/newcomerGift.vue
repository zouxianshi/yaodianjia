<template>
  <div class="newcommer-modal app-container">
    <div class="nav-tool">
      <el-button type="primary" :disabled="tableData.length>=2" @click="$router.push('/activity/newcomer-create')">新增新人礼包活动</el-button>
    </div>
    <el-table v-loading="loading" height="calc(100vh - 300px)" :data="tableData" style="width: 100%">
      ...
      <el-table-column label="操作" width="220">
        <template slot-scope="scope">
          ...
          <el-button v-if="scope.row.state===2" size="mini">编辑</el-button>
