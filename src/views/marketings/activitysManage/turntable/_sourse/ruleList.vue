  ...
  <div class="rule-ruleList-modal">
    ...
    >
      ...
      <el-form-item>
        ...
        <div v-if="intrShow && this.$route.query.code==='TA004'" class="intrwarning">
          ...
          <ul>
            <li>1. 免费参与：创建抽奖活动后，将链接发布至商城首页或打印活动二维码，会员进入免费参与抽奖，较适用于小面额优惠券抽奖，提高用户活跃，促进商品销售；</li>
            <li>2. 积分参与：会员需要消耗一定的积分才能参与抽奖， 消耗会员积分库存，设置活动后可以将链接发布至微商城广告位，或打印二维码制作海报，会员扫码参与抽奖；</li>
            <li>3. 活动参与：适用于支付满一定金额获得抽奖机会的奖励，可以提高用户活跃，创建一个刮刮乐活动后，设置抽奖次数，然后在支付有礼中，添加支付后权益为参与抽奖，会员在微商城或线下消费满足条件后，触发抽奖机会入口，会员进入参与抽奖。</li>
          </ul>
        </div>
        <div slot="label">
          活动规则
      ...
      <el-form-item label="参与方式" prop="integralRule">
        <el-radio-group v-model="ruleForm.joinRule" :disabled="isRuning" style="width:120px;font-size: 18px;line-height: inherit;" @change="ruleForm.integralRule=0">
