        ...
        <div class="goodsBox">
          ...
          >
            ...
            <p>
              ...
              <br>第三条 你方权利义务
              <br>1、你方应当使用真实身份信息及个人资料，不得以虚假、冒用的居民身份信息、企业注册信息、组织机构代码信息进行注册并认证。若你方的个人资料有任何变动，应及时更新。我方禁止未成年人直播，若法定监护人希望未成年人得以提供本协议约定的网络直播及解说服务的，必须以法定监护人身份加以判断该等服务内容是否适合于未成年人，并由法定监护人承担因此而导致的一切后果。你方承诺不会因执行本协议损害任何第三方合法利益，你方接受并履行本协议不违反任何对你有约束力的法律文件，亦不会使我方对任何第三方承担责任。
              ...
              <br>第四条 服务费用及结算
              <br>1、以你方为平台用户提供解说直播服务为前提，用户可对你方进行赠送虚拟礼物的消费，你方可根据我方的结算要求及规则申请结算相应的服务费用（若有）。我方就你方收到的每笔虚拟礼物以数量为计价单位，且以一定的比例为价值基准进行兑换结算，作为支付给你方的服务费用。对于非正常手段获得的虚拟礼物消费，我方有权进行独立判断和处理。
              ...
              <br>第五条 保密制度
              <br>1、你方应严格遵守我方的保密制度，承诺无限期保守我方的商业秘密。因你方违反约定使用或披露我方商业秘密和信息使我方遭受任何名誉、声誉或经济上的、直接或间接的损失，你方应赔偿我方人民币[ 100000 ]元违约金，不足以弥补我方损失的，你方还应赔偿我方损失。
              ...
              <br>第六条 协议的变更、解除、终止
              <br>1、我方有权在必要时变更、中止、终止本协议，并在相关页面进行通知，变更后的协议一旦在相关的页面上公布即有效代替原来的协议。本协议条款变更后，如你方继续为我方平台用户提供解说等直播服务，即视为你方已知悉并接受变更后的协议。如你方不同意我方对本协议的所作的任何变更，你方应立即书面通知我方并停止在我方平台进行的任何直播服务。
              ...
              <br>第七条 违约责任
              <br>1、任何由于你方声明不实或违反其声明承诺事项导致他方向我方提起诉讼、索赔及/或导致我方声誉受损之后果，你方将承担我方因此产生的全部直接及间接费用、损失及赔偿，其中包括我方为诉讼支付的有关费用及律师费。
              ...
              <br>第八条 争议处理
              <br>因履行本协议而产生的任何争议，双方均应本着友好协商的原则加以解决。协商解决未果，任何一方均可以提请上海市东湖新技术开发区人民法院诉讼解决。
            </p>
            <span slot="footer" class="dialog-footer">
