        ...
        <div class="goodsBox">
          ...
          >
            <p>
              ...
              2、签署本协议前，你方已充分了解我方之各项规则及要求，且有条件及有能力、资格履行本协议约定的直播方职责及义务。本协议对你方构成有效的、带有约束力的、可强制执行的法定义务，你方对本协议下所有条款及定义等内容均已明确知悉，并无疑义。
              3、你方承诺并声明在为我方提供服务时符合所在地法律的相关规定，不得以履行本协议名义从事其他违反中国及所在地法律规定的行为。
              4、你方与我方不构成任何劳动法律层面的雇佣、劳动、劳务关系，我方无需向你方支付社会保险金和福利。
              5、未经我方事先书面同意，你方不得在第三方竞争平台上从事任何与解说相关的行为（包括但不限于：视频直播互动、同步推流、发布解说视频或其余类似行为）。前述第三方竞争平台指：与我方及我方关联公司有竞争关系的第三方直播平台，包括但不限于虎牙直播、战旗TV、熊猫TV、火猫直播、风云直播、播狗、新浪游戏、QT、17173、PPTV、TGA、AZUBU、TWITCH等及其相关联的直播网站。
              6、 你方在注册成为海典主播或在海典平台进行直播服务前已确认，未与任何第三方平台签署或存在有效存续的独家直播解说协议。
              7、 在双方合作期间，你方直播、上传、发布或传输等内容的相关权利，适用于《用户注册协议》“4.2服务规范”中条款的约定。
              第二条 我方权利义务
              1、我方有权制定平台运营制度及对直播方的管理规则，并将其作为本协议的一部分，有权对你方进行管理和监督，有权根据运营情况对相应规则做出调整或变更，你方对此表示理解和同意。
              2、我方有权对你方进行考察、评判，以确立（取消）对你方的奖励或处罚，具体考察项目及标准由我方另行制定，无需额外征得你方同意。如我方要求与你方另行签订正式的解说合作协议的，你方不得拒绝或以其他形式变相拒绝签订【否则你方应一次性向我方支付违约金【50000】（大写：伍万）元】。
              3、我方有权对你方的直播服务提出改进建议和意见，你方应在收到我方的建议和意见后【3】个工作日内进行相应的整改，否则我方有权限制、关闭、回收、或终止你方对海典直播间的使用，相应扣减应支付给你方的服务费用（若有）可能会给你方造成一定的损失，该损失由你方自行承担，我方不承担任何责任。
              4、我方对你方进行的解说直播相关事宜拥有最终决定权。
              5、我方有权使用你方的的名称（包括但不限于你方真实姓名、笔名、网名、曾用名及任何代表你方身份的文字符号）、肖像（包括但不限于真人肖像及卡通肖像等）进行我方平台的各类宣传。
              6、我方负责提供平台技术服务支持，同时负责平台服务费用结算（若有）。
              第三条 你方权利义务
              1、你方应当使用真实身份信息及个人资料，不得以虚假、冒用的居民身份信息、企业注册信息、组织机构代码信息进行注册并认证。若你方的个人资料有任何变动，应及时更新。我方禁止未成年人直播，若法定监护人希望未成年人得以提供本协议约定的网络直播及解说服务的，必须以法定监护人身份加以判断该等服务内容是否适合于未成年人，并由法定监护人承担因此而导致的一切后果。你方承诺不会因执行本协议损害任何第三方合法利益，你方接受并履行本协议不违反任何对你有约束力的法律文件，亦不会使我方对任何第三方承担责任。
              2、你方自己承担进行解说直播所需要的网络、支持视频和语音的设备，并保证直播图像清、语音质量清晰、稳定。
              3、你方承诺，愿意遵照平台设定的直播间申请程序，提交平台所需的申请材料并自愿缴付相应的保证金。
              4、你方承诺直播房间必须作解说直播用途，不得用于其他任何非解说直播性质的活动。
              5、你方开展本协议项下解说直播事项和/或在本平台上发布的所有信息/资讯/言论/内容等均不得含有任何违反中华人民共和国有关法律、法规及规定的内容，包括但不限于危害国家安全、淫秽色情、虚假、违法、诽谤（包括商业诽谤）、非法恐吓或非法骚扰、侵犯他人知识产权、人身权、商业秘密或其他合法权益以及有违公序良俗的内容或指向这些内容的链接。
              6、你方承诺积极维护我方及我方平台形象，你方不会做出有损于我方及/或我方平台形象或利益的行为，本协议期内及协议终止后，你方不会通过任何渠道（包括但不限于网站、博客、微博、微信、QQ聊天群、玩家聚会等）暗示或发布不利于我方及/或我方平台的言论。
              7、未经我方书面同意，你方不得在任何场合以任何形式（包括但不限于文字、口播、视频贴片等）提及第三方竞争平台的相关信息，不得引导或为我方平台现有用户、其他直播方及我方员工进入其他第三方竞争平台提供任何信息或便利，包括但不限于提供联络上的协助、进行说服工作等。
              8、您特此陈述并保证：(1）您当前并未在受美国制裁国家或地区（包括但不限于克里米亚、古巴、伊朗、北朝鲜、及叙利亚）居住或停留；(2）您并不属于美国政府禁止或限制主体名单（包括美国财政部海外资产办公室管理的《特别指定国民名单》Specially Designated Nationals and Blocked Persons List）的主体或人员；(3）您并不属于其他任何遭受美国或联合国经济制裁名单主体或人员，该等名单包括但不限于a）《行业制裁识别名单》Sectoral Sanctions Identifications List；b)《海外逃避制裁者名单》 Foreign Sanctions Evaders List；c)《巴勒斯坦立法会名单》NON-SDN Palestinian Legislative Council List；d)《非SDN涉伊朗制裁法案名单》Non-SDN Iran Sanctions Act List等。
              第四条 服务费用及结算
              ...
              2、商业秘密是指由我方提供的、或者你方在双方合作期间了解到的、或者我方对第三方承担保密义务的，与我方业务有关的，能为我方带来经济利益，具有实用性的、非公知的所有信息，包括（但不限于）：技术信息、经营信息和与我方行政管理有关的信息和文件（含本协议及相关协议内容）、你方从我方获得的服务费用的金额和结算方式、标准、权利归属方式、授权方式、客户名单、其他解说员的名单、联系方式、服务费用、我方工作人员名单等不为公众所知悉的信息。
              3、你方应严格遵守本协议，未经我方书面授权或同意，对我方的商业秘密不得：
              （1）以任何方式向第三方或不特定的公众进行传播、泄露；
              （2）为非本协议的目的而使用我方的商业秘密。
              4、本协议终止后，你方应将我方商业秘密悉数返还我方，或在我方监督下，将记载我方商业秘密的全部文件销毁。
              5、本条规定在本协议终止后仍然有效。
              第六条 协议的变更、解除、终止
              ...
              4、由于本协议第六条第1、2款造成的协议解除、终止，我方按本协议第四条规定及我方平台实时政策约定与你方结算服务费用。
              5、由于本协议第六条第3款造成的协议解除、终止，我方有权扣除你方帐号中尚未结算的全部服务费用，并有权要求你方按约定承担违约责任。
              6、本协议终止后，不影响本协议约定的直播方成果的权利归属，我方仍为本协议所涉直播方成果的权利人；如果根据中国法律，上述之约定无法实际履行的，你方同意并承诺自本协议终止或双方后续合作中止、终止或解除之日起五年内不将直播方成果的全部或部分的发布、使用等相关的权利（包括但不限于《中华人民共和国著作权法》第十条第一款第（五）项至第（十七）项规定的著作权权利）自行行使、转让或授权许可于任何第三方。
              第七条 违约责任
              1、任何由于你方声明不实或违反其声明承诺事项导致他方向我方提起诉讼、索赔及/或导致我方声誉受损之后果，你方将承担我方因此产生的全部直接及间接费用、损失及赔偿，其中包括我方为诉讼支付的有关费用及律师费。
              2、除本协议另有约定外，你方违反本协议下任何规定或你方提供的服务不符合我方的要求，我方有权单方面采取相应限制或处罚措施，包括但不限于：限制、关闭、回收、或终止你方对海典直播间的使用，限制或停止某项单独服务（如视频直播）并根据实际情况决定是否恢复使用，扣除你方帐号中尚未结算的服务费用。
              第八条 争议处理
