    ...
    <div v-loading="pageLoading" class="app-container" element-loading-text="加载中">
      ...
      <section class="x-body">
        ...
        <ul class="template-list">
          <li v-for="item in 6" :key="item" class="li-item">
            <div class="cover-box">
              <div class="cover" />
              <div class="mask">
          ...
          <li class="li-item li-add">
            <div class="cover-box">
              <div class="text">空白模板</div>
              <div class="mask">
                <el-button type="primary" size="small" @click="toSetModule">设置模板</el-button>
              </div>
            </div>
            <div class="caption-box">
...
export default {
  ...
  methods: {
    toSetModule() {
      this.$router.push('/marketing/activity/dm-edit')
    }
  }
}
</script>
      ...
      .li-item{
        ...
        .cover-box {
          ...
          .cover{
            width: 100%;
            height: 100%;
            background: url('../../../../assets/image/template_bg.png') no-repeat center/100% 100%;
          }
          .mask{
            display: none;
            position: absolute;
