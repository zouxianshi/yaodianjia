...
export default [{
  ...
  children: [
    ...
    {
      path: '/marketings/dm',
      component: () => import('@/views/marketings/dm'),
      name: 'marketings-dm',
      redirect: '/marketings/dm/list',
      meta: {
        title: 'DM单列表',
        auth: false,
        noCache: true
      ...
      children: [
        {
          path: '/marketings/dm/list',
          component: () => import('@/views/marketings/dm/list'),
          name: 'marketings-dm-list',
          meta: {
            title: 'DM单列表',
            auth: false,
            noCache: true
        ...
        {
          path: '/marketings/dm/settings',
          component: () => import('@/views/marketings/dm/settings'),
          name: 'marketings-dm-settings',
          meta: {
            title: 'DM单设置',
            auth: false,
            noCache: true,
            activeMenu: '/marketings/dm/list'
          },
          children: []
        }
      ]
